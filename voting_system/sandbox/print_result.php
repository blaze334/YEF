...
<!-- Header -->
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation"style="background: skyblue; border: skyblue;">
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            if(!isset($_GET['organization'])) {
                ...
                <div class="logo-title">
                    ...
                    <table>
                        <tr>
                            <td><img src="../assets/img/ysu.jpg" style="width:77px;height:77px;"></td>
                            <td><br/>
                                <p style="text-align: left;">
                                    <b>YOBE STATE UNIVERSITY</b><br />
                                    DAMATURU<br />
...
<!-- Footer -->
<nav class="navbar navbar-inverse navbar-fixed-bottom" role="navigation" style="background: skyblue; border: skyblue;">
